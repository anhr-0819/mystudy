...
<div>
  ...
  <ul>
<%
  List<AttachedFile> files = (List<AttachedFile>) request.getAttribute("attachedFiles");
  for (AttachedFile file : files) {
%>
    <li>
    <a href='/upload/board/<%=file.getFilePath()%>'><%=file.getFilePath()%></a> [<a href='/board/file/delete?category=<%=category%>&no=<%=board.getNo()%>'>삭제</a>]
    </li>
<%}%>
  </ul>
</div>
