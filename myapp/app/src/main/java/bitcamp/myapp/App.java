...
import bitcamp.myapp.Menu.BoardListeHandler;
...
//    new MainMenu(prompt).execute();
    ...
    MeunHandler boardAddHandler = new BoardAddHandler(boardRepository, prompt);
...
//    boardMenu.add(new MenuItem("삭제", new BoardDeleteHandler()));
    boardMenu.add(new MenuItem("목록", new BoardListeHandler(boardRepository)));
