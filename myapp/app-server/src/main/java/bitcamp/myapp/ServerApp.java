...
public class ServerApp {
  ...
  void prepareDatabase() {
    try {
      // JVM이 JDBC 드라이버 파일(.jar)에 설정된대로 자동으로 처리한다. 코드 생략 가능!
//      Driver driver = new com.mysql.jdbc.Driver();
//      DriverManager.registerDriver(driver);

//      Connection con =
//          DriverManager.getConnection("jdbc:mysql://db-ld262-kr.vpc-pub-cdb.ntruss.com/studydb",
//              "study", "Bitcamp!@#123");
      // jdbc:mysql://localhost/studydb", "study", "Bitcamp!@#123

      DBConnectionPool DBConnectionPool = new DBConnectionPool(
          "jdbc:mysql://db-ld262-kr.vpc-pub-cdb.ntruss.com/studydb", "study", "Bitcamp!@#123");
  ...
  void prepareMenu() {
    ...
    assignmentMenu.addItem("등록", new AssignmentAddHandler(DBConnectionPool, assignmentDao));
    ...
    boardMenu.addItem("등록", new BoardAddHandler(DBConnectionPool, boardDao));
    ...
    greetingMenu.addItem("등록", new BoardAddHandler(DBConnectionPool, greetingDao));
...
// 서버에서는 최종적으로 출력이 끝나면 반드시 end()를 호출해야한다. <= nodejs 방식